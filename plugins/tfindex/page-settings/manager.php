<?php
namespace ElementorTFIndex\PageSettings;
...
class Page_Settings {
	...
	public function add_panel_tab() {
		Controls_Manager::add_tab( self::PANEL_TAB, __( 'New Tab', 'elementor-tfindex' ) );
	}
	...
	public function register_document_controls( $document ) {
		...
		$document->start_controls_section(
			'new_section',
			[
				'label' => __( 'Settings', 'elementor-tfindex' ),
				'tab' => self::PANEL_TAB,
			]
		);
		...
		$document->add_control(
			'text',
			[
				'label' => __( 'Title', 'elementor-tfindex' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Title', 'elementor-tfindex' ),
			]
		);
