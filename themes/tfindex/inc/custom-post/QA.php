...
if ( ! function_exists('question_answer_post_type') ) {

// Register Custom Post Type
    function question_answer_post_type() {

        $labels = array(
            'name'                  => _x( 'QA', 'Post Type General Name', 'tfindex' ),
            'singular_name'         => _x( 'QA', 'Post Type Singular Name', 'tfindex' ),
            'menu_name'             => __( 'TFindex QA', 'tfindex' ),
            'name_admin_bar'        => __( 'QA', 'tfindex' ),
...
//			'taxonomies'            => array( 'category', 'post_tag' ),
    ...
    add_action( 'init', 'question_answer_post_type', 0 );
