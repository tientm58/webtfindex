...
if ( ! function_exists('reports_post_type') ) {

// Register Custom Post Type
    function reports_post_type() {

        $labels = array(
            'singular_name'         => _x( 'Báo cáo phân tích', 'Post Type Singular Name', 'tfindex' ),
            'menu_name'             => __( 'Báo cáo phân tích', 'tfindex' ),
            'name_admin_bar'        => __( 'Báo cáo phân tích', 'tfindex' ),
        ...
        $args = array(
            'label'                 => __( 'Báo cáo phân tích', 'tfindex' ),
