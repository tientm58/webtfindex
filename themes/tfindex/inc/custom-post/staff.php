...
// Register Custom Post Type
    function staff_post_type() {
        ...
        $labels = array(
            'name'                  => _x( 'Staff', 'Post Type General Name', 'tfindex' ),
            'singular_name'         => _x( 'Staff', 'Post Type Singular Name', 'tfindex' ),
            'menu_name'             => __( 'TFindex Staff', 'tfindex' ),
            'name_admin_bar'        => __( 'Staff', 'tfindex' ),
