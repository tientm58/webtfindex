...
if ( ! function_exists('tfindexs_post_type') ) {

// Register Custom Post Type
    function tfindexs_post_type() {

        $labels = array(
            'name'                  => _x( 'TFindex', 'Post Type General Name', 'tfindex' ),
            'singular_name'         => _x( 'TFindex', 'Post Type Singular Name', 'tfindex' ),
            'menu_name'             => __( 'TFindex', 'tfindex' ),
            'name_admin_bar'        => __( 'TFindex', 'tfindex' ),
...
//			'taxonomies'            => array( 'category', 'post_tag' ),
        ...
        register_post_type( 'tfindex', $args );

    }
    add_action( 'init', 'tfindexs_post_type', 0 );
