...
if ( ! function_exists('tftalks_post_type') ) {

// Register Custom Post Type
    function tftalks_post_type() {
...
//			'taxonomies'            => array( 'category', 'post_tag' ),
        ...
        register_post_type( 'tftalk', $args );

    }
    add_action( 'init', 'tftalks_post_type', 0 );
