...
if ( ! function_exists('thuyen_post_type') ) {

// Register Custom Post Type
    function thuyen_post_type() {

        $labels = array(
            'name'                  => _x( 'Thuyền', 'Post Type General Name', 'tfindex' ),
            'singular_name'         => _x( 'Thuyền', 'Post Type Singular Name', 'tfindex' ),
            'menu_name'             => __( 'Thuyền', 'tfindex' ),
            'name_admin_bar'        => __( 'Thuyền', 'tfindex' ),
...
//			'taxonomies'            => array( 'category', 'post_tag' ),
        ...
        register_post_type( 'thuyen', $args );

    }
    add_action( 'init', 'thuyen_post_type', 0 );
